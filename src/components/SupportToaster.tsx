...
export const SupportToaster: React.FC<SupportToasterProps> = ({
	className,
}) => {
	const getDonationStatus = getOptionalElectronMethod("getDonationStatus");
	const markDonationToastShown = getOptionalElectronMethod(
		...
		const handleFocus = async () => {
			if (clickTimeRef.current) {
				...
				if (elapsed > 20000) {
					// 20 seconds
					console.log(
						"User returned from support link after >20s. Presuming donation.",
					);
						...
						<div className="pt-[42px] flex flex-col items-center w-full px-[40px]">
							...
							<div className="flex flex-col items-center text-center">
								...
								<p className="text-[14px] leading-[1.6] text-white/60 max-w-[480px] font-medium antialiased">
									Natively is built and maintained by one developer.
									<br />
