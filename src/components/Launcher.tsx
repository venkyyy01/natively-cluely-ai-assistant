                                ...
                                "
										>
											...
											<img
												src={icon}
												alt="Logo"
												className="w-[18px] h-[18px] object-contain brightness-0 invert drop-shadow-[0_1px_2px_rgba(0,0,0,0.1)] opacity-90"
											/>
												...
												<div className="space-y-1">
													{groupedMeetings[label].map((m) => {
														...
														return (
															...
															>
																<div
																	className={`font-medium text-[14px] max-w-[60%] truncate ${isMeetingProcessing ? "text-blue-400 italic animate-pulse" : "text-text-primary"}`}
																>
																	{m.title}
																</div>
