...
import { Calendar, FlaskConical, Info, Keyboard, LogOut, Mic, Monitor, User, X } from 'lucide-react';

interface SettingsSidebarProps {
  activeTab: string;
  setActiveTab: (tab: 'general' | 'ai-providers' | 'calendar' | 'audio' | 'keybinds' | 'profile' | 'about') => void;
  onClose: () => void;
  onProfileOpen: () => void;
}

export const SettingsSidebar: React.FC<SettingsSidebarProps> = ({ activeTab, setActiveTab, onClose, onProfileOpen }) => {
  const items = [
