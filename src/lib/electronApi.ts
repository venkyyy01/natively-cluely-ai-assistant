...
type ElectronMethod<T extends keyof ElectronAPI> = Extract<
	ElectronAPI[T],
	(...args: any[]) => any
>;
...
export function requireElectronMethod<T extends keyof ElectronAPI>(
	method: T,
): ElectronMethod<T> {
...
export function getOptionalElectronMethod<T extends keyof ElectronAPI>(
	method: T,
): ElectronMethod<T> | null {
