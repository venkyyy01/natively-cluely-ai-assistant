...
const EVAL_CASES = [
	...
	},
	{
		id: "behavioral-02",
		expected: "behavioral",
		text: "Describe a situation where you had to influence people without formal authority.",
	},
	{
		id: "behavioral-03",
		expected: "behavioral",
	...
	},
	{
		id: "coding-01",
		expected: "coding",
		text: "Implement debouncing in JavaScript.",
	},
	{
		id: "coding-02",
		expected: "coding",
	...
	},
	{
		id: "deep-dive-01",
		expected: "deep_dive",
		text: "Why would you choose Kafka over RabbitMQ for this architecture?",
	},
	{
		id: "deep-dive-02",
		expected: "deep_dive",
		text: "Explain the tradeoffs you made between consistency and availability.",
	},
	{
		id: "deep-dive-03",
		expected: "deep_dive",
		text: "How would you handle conflict between cache freshness and latency?",
	},
	{
		id: "clarification-01",
	...
	},
	{
		id: "clarification-03",
		expected: "clarification",
		text: "Sorry, can you clarify the scope boundary you drew between services?",
	},
	{
		id: "follow-up-01",
		expected: "follow_up",
	...
	},
	{
		id: "follow-up-03",
		expected: "follow_up",
		text: "After that, how did you roll out the fix safely?",
	},
	{
		id: "example-01",
	...
	},
	{
		id: "summary-03",
		expected: "summary_probe",
		text: "So to summarize, your first step is hot partition isolation?",
	},
	{
		id: "general-01",
		expected: "general",
	...
	},
	{
		id: "general-03",
		expected: "general",
		text: "Do you have any questions for us about the position?",
	},
	{
		id: "ambiguous-01",
		expected: "example_request",
	...
	},
	{
		id: "ambiguous-02",
		expected: "clarification",
		text: "Can you clarify that part about replay protection?",
	},
	{
		id: "ambiguous-03",
		expected: "follow_up",
...
async function main() {
	...
	console.log(
		`Overall: ${correct}/${EVAL_CASES.length} (${((correct / EVAL_CASES.length) * 100).toFixed(1)}%)\n`,
	);

	const perIntent = {};
	for (const r of results) {
		if (!perIntent[r.expected])
			perIntent[r.expected] = { total: 0, correct: 0 };
	...
	for (const [intent, stats] of Object.entries(perIntent)) {
		console.log(
			`  ${intent}: ${stats.correct}/${stats.total} (${((stats.correct / stats.total) * 100).toFixed(0)}%)`,
		);
	}
	...
	for (const r of results) {
		if (!r.correct) {
			console.log(
				`  ${r.id}: expected=${r.expected} predicted=${r.predicted} conf=${(r.confidence * 100).toFixed(1)}%`,
			);
		}
	}
}
