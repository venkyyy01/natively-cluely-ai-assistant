...
try {
  ...
  console.log(`${fs.existsSync(binPath) ? '✅' : '❌'} binary exists (${binPath})`);
  ...
  try {
    ...
    console.log(`${typeof nativeModule.MicrophoneCapture === 'function' ? '✅' : '❌'} MicrophoneCapture constructor available`);
  } catch (loadError) {
