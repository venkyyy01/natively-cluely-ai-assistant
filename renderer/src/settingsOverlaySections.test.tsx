...
const settingsOverlayPath = path.resolve(__dirname, '../../src/components/SettingsOverlay.tsx');
...
test('keeps the extracted speech provider section wired into the audio tab', () => {
  ...
  expect(source).toContain("import { SpeechProviderSection } from './settings/SpeechProviderSection';");
