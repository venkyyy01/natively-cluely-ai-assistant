                    ...
                    >
                        ...
                        <div className="w-full px-[32px] mt-6 mb-8 flex flex-col gap-3">
                            ...
                            <div className="bg-white/5 border border-white/5 rounded-[16px] rounded-tl-sm p-4 w-[90%] self-start relative shadow-sm opacity-60 hover:opacity-100 transition-opacity">
                                <span className="absolute -top-[10px] left-4 bg-[#2A2B2E] border border-white/10 text-white/50 text-[9px] uppercase font-bold px-2 py-0.5 rounded-full tracking-wider">Without JD Awareness</span>
                                <p className="text-[13px] text-white/60 leading-relaxed mt-1">"I have a strong background in software engineering and I'm a quick learner. I enjoy solving complex problems and working in a fast-paced team environment."</p>
                            </div>
