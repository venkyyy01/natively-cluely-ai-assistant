...
export class IntelligenceManager extends EventEmitter {
	...
	async handleSuggestionTrigger(
		trigger: import("./SessionTracker").SuggestionTrigger,
	): Promise<void> {
