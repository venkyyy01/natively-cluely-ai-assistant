export type QuestionType = 'clarification' | 'information' | 'confirmation' | 'rhetorical';
...
const QUESTION_WORDS = /^(?:what|who|where|when|why|how|which|can|could|would|should|is|are|do|does|did|will|have|has)\b/i;
const QUESTION_ENDING = /\?\s*$/;
const CONFIRMATION_PATTERNS = /(?:right|correct|isn'?t it|don'?t you think|wouldn'?t you say)\b/i;
const CLARIFICATION_PATTERNS = /(?:what do you mean|could you clarify|can you explain|what exactly)\b/i;
