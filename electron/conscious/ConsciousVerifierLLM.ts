import type { ConsciousVerificationResult, ConsciousVerifierJudge, ConsciousVerifierJudgeInput } from './ConsciousVerifier';
...
export class ConsciousVerifierLLM implements ConsciousVerifierJudge {
  constructor(private readonly client: StructuredJudgeClient, private readonly timeoutMs: number = CONSCIOUS_VERIFIER_JUDGE_TIMEOUT_MS) {}

  async judge(input: ConsciousVerifierJudgeInput): Promise<ConsciousVerificationResult | null> {
