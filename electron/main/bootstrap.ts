import { app, globalShortcut, session, systemPreferences } from "electron";
...
export async function initializeApp() {
	...
	if (previousUnclean) {
		console.warn(
			"[Bootstrap] Previous session exited uncleanly. Running startup healing...",
		);
	}
	...
	const {
		CredentialsManager: CredentialsManagerClass,
