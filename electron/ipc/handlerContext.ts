...
export interface HandlerContext {
	...
	ok: OkFn;
	fail: FailFn;
	getInferenceLlmHelper: () => ReturnType<
...
export function createHandlerContext(appState: AppState): HandlerContext {
	...
	const safeHandleValidated: SafeHandleValidated = (
		channel,
		parser,
		listener,
	) => {
	...
	const activeChatControllers =
		typeof appState.getActiveChatControllers === "function"
			? appState.getActiveChatControllers()
			: new Map<string, AbortController>();
	const streamChatStartedAt =
		typeof appState.getStreamChatStartedAt === "function"
