...
import { attachRendererBridgeMonitor, type RendererBridgeSettledResult } from '../runtime/rendererBridgeHealth';
...
function attachProbe(win: FakeWindow, settled: RendererBridgeSettledResult[]): void {
