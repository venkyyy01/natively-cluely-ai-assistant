  ...
  (axios as any).get = async () => ({
    data: {
      models: [
        ...
        { name: 'models/gemini-3.0-flash', displayName: 'Gemini 3 Flash', supportedGenerationMethods: ['generateContent'] },
        { name: 'models/gemini-2.0-nano', displayName: 'Gemini Nano', supportedGenerationMethods: ['generateContent'] },
        { name: 'models/gemini-3.0-vision', displayName: 'Gemini Vision', supportedGenerationMethods: ['generateContent'] },
        { name: 'models/text-bison', displayName: 'Text Bison', supportedGenerationMethods: ['embedContent'] },
      ],
    },
  });
