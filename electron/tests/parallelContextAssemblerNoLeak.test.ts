...
function makeInput(seed: number): ContextAssemblyInput {
  return {
    ...
    transcript: [
      { speaker: 'interviewer', text: 'Walk me through caches.', timestamp: Date.now() - 60_000 },
      { speaker: 'user', text: 'I would consider TTL and consistent hashing.', timestamp: Date.now() - 30_000 },
    ],
