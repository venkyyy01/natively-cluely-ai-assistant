...
export const DEFAULT_KEYBINDS: KeybindConfig[] = [
  ...
  { id: 'general:toggle-visibility', label: 'Toggle Visibility', accelerator: 'Command+Alt+Shift+V', alternateAccelerators: ['Command+B', 'Command+Shift+Space', 'F13'], isGlobal: true, defaultAccelerator: 'Command+Alt+Shift+V' },
  ...
  { id: 'general:restore-full-stealth', label: 'Restore Full Stealth', accelerator: 'Shift+Esc', isGlobal: true, defaultAccelerator: 'Shift+Esc' },
    ...
    { id: 'general:take-screenshot', label: 'Take Screenshot', accelerator: 'Command+Alt+Shift+S', alternateAccelerators: ['F14', 'Command+Shift+S', 'Command+Shift+\\'], isGlobal: true, defaultAccelerator: 'Command+Alt+Shift+S' },
    ...
    { id: 'general:toggle-cursor-hook', label: 'Toggle Cursor Stealth', accelerator: 'Command+Shift+-', isGlobal: true, defaultAccelerator: 'Command+Shift+-' },
