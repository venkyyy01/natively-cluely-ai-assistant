...
const mapModifiers = (modifiers: string[] | undefined): string[] =>
	modifiers ?? [];

const isPrintableKey = (event: StealthKeyboardInputEvent): boolean =>
	event.key.length === 1 && !event.modifiers?.includes("meta");
