...
export const DEEP_STEALTH_SCAFFOLDS: DeepStealthProjectRecord[] = [
  {
    ...
    nextStep: 'Expand into the macOS secure presenter, CGVirtualDisplay/compositor path, and Layer 3 feasibility program.',
  },
  {
  ...
  },
  {
    ...
    nextStep: 'Deferred: revisit only after the macOS Layer 3 program completes and product requirements still demand Layer 4.',
  },
  {
    ...
    ownerSurface: 'native-runtime',
    nextStep: 'Automate the macOS Layer 3 capture-validation matrix, including API-level probes and TCC workflows.',
  },
];
