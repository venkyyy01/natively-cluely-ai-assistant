...
import { createRequestAbortController, GROQ_MODEL, LLM_API_TIMEOUT_MS, withTimeout } from '../../LLMHelper';
import fs from 'fs';
...
export async function generateWithGroq(
  ...
  return helper.withResponseCache('groq', targetModel, '', payloadHash, async () => {
